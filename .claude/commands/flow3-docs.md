...
Will apply CRITICAL and IMPORTANT gaps in Step 6 (with your Allow per change).
...
- Commit changes: Use flow1.commit.prompt.md for conventional commit
...
- Or re-run this command and Allow them
```
...
- ❌ Internal development tools (.cursor/commands/flow*.md, .github/prompts/flow*.prompt.md)
