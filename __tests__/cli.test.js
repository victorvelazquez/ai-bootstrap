...
const createTempDir = () =>
  fs.mkdtempSync(path.join(os.tmpdir(), "ai-flow-test-"));
...
describe("ai-flow CLI", () => {
  ...
  it("initializes fullstack project when --type fullstack is supplied", () => {
    ...
    const backendPromptPath = path.join(
      tempDir,
      ".cursor",
      "commands",
      "backend-bootstrap.md"
    );
    const frontendPromptPath = path.join(
      tempDir,
      ".cursor",
  ...
  it("initializes mobile project when --type mobile is supplied", () => {
    ...
    const mobilePromptPath = path.join(
      tempDir,
      ".cursor",
      "commands",
      "bootstrap.md"
    ...
    const mobileTemplatePath = path.join(
      tempDir,
      ".ai-flow",
      "templates",
      "README.md"
