...
const createTempDir = () => fs.mkdtempSync(path.join(os.tmpdir(), 'ai-bootstrap-render-'));
...
describe('template rendering', () => {
  ...
  it('generates templates and preserves handlebars placeholders', () => {
    ...
    const aiInstructions = path.join(tempDir, '.ai-bootstrap', 'templates', 'ai-instructions.md');
