...
Your mission is to detect changes in the frontend codebase and update the project documentation automatically when the user executes `/docs-update`.
...
1. **Perform Current Code Analysis:**
   ...
   - Execute the same analysis as Phase 0 (frontend/bootstrap-phase0-context.md):
